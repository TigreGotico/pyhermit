...
PyHermit is a Python port of the HermiT OWL 2 DL reasoner.

## Getting started

1. [Installation](./installation.md): set up PyHermit.
2. [Concepts](./concepts.md): what ontologies and reasoning are.
...
Detection uses a fixpoint propagation through `simple_object_property_inclusions` and always marks inverses of complex properties as complex. Source: `ObjectPropertyInclusionManager._detect_complex_properties`, at `src/hermit/structural/object_property_inclusion_manager.py:311`.
...
- [HermiT Official](http://hermit-reasoner.com): the original Java reasoner.
- [OWL 2 Specification](https://www.w3.org/OWL/): the W3C standard.
